...
class AccountHelper
{
     ...
     * -----------------------------------------------------*/
    public function CreateNewUser($username, $email, $password) : bool
    {
        $user_id = uniqid();
        $password = password_hash($password, PASSWORD_DEFAULT);

        $acLib = new Libraries\Authentication();
        //$result = $acLib->CreateNewUser($mail, $password, 'admin');
    }
